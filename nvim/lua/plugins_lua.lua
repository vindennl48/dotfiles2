...
-- vim.api.nvim_set_hl(0, "Comment", { fg = "#32CD32", italic = true })
vim.api.nvim_set_hl(0, "Comment", { fg = "#3da138", italic = true })
-- vim.api.nvim_set_hl(0, "Comment", { fg = "#38b555", italic = true })
-- vim.api.nvim_set_hl(0, "Comment", { fg = "#40d663", italic = true })
