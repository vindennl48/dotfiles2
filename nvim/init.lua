...
-- PLUGINS ---------------------------------------------------------------------
--------------------------------------------------------------------------------
cmd('source $HOME/.local/share/nvim/site/autoload/plug.vim')
call('plug#begin', '$HOME/.local/share/nvim/plugins')

-- Plug('catppuccin/nvim', { ['as'] = 'catppuccin' }) -- cool color scheme
Plug 'EdenEast/nightfox.nvim' -- cool color scheme
...
Plug 'lukas-reineke/indent-blankline.nvim' -- colorful indents
Plug('neoclide/coc.nvim', { ['branch'] = 'release' }) -- code completion
Plug 'stevearc/oil.nvim' -- file explorer
Plug 'supermaven-inc/supermaven-nvim' -- AI autocomplete
